...
def road(mc,x,y,z):
    #air
    mc.setBlocks(x-5,y-2,z+1,x+5,y,z+100,0)
    mc.setBlocks(x,y-2,z+1,x,y,z+100,0)
    #road
    mc.setBlocks(x-5,y-2,z+1,x+5,y,z+100,1)
    mc.setBlocks(x,y-2,z+1,x,y,z+100,80)
    #curb
    #mc.setBlocks(x-5,y-2,z+1,x+5,y,z+100,1)
    #mc.setBlocks(x,y-2,z+1,x,y,z+100,    
...
def colors(mc,x,y,z):
  ...
  thecolor = 0
  while(done < 32):
    mc.setBlock(x,y+10,z+done,35,thecolor)
    mc.setBlocks(x-1,y-1+done,z-1,x+1,y+1+done,z+1,35,thecolor)
    done = done + 1
    thecolor = thecolor +1
...
def airSeat(mc,x,y,z):
  mc.setBlocks(x-2,y,z+8,x+10,y+20,z+5,20)
